...
const WebcamPreview: React.FC<WebcamPreviewProps> = ({
  ...
  return (
    <div className="fixed bottom-4 right-4 w-80 h-52 bg-black/60 border-2 border-blue-500/30 rounded-xl overflow-hidden backdrop-blur-md z-50 shadow-[0_0_20px_rgba(0,0,0,0.5)] pointer-events-none transition-opacity duration-500">
      {/* Header/Label */}
